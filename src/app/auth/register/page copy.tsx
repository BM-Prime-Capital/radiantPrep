...
<form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
  ...
  <div className="space-y-1">
    <h3 className="text-sm font-medium text-gray-700">Parent Information</h3>
    <div className="grid grid-cols-2 gap-4">
      <div>
        <Input 
          type="text"
          className="w-full h-14 px-4 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1E9B3B] focus:border-[#1E9B3B]"
          placeholder="First Name"
          {...register('parentFirstName')}
        />
        {errors.parentFirstName && <p className="text-xs text-red-500 mt-1">{errors.parentFirstName.message}</p>}
      </div>
      <div>
        <Input 
          type="text"
        ...
        />
        {errors.parentLastName && <p className="text-xs text-red-500 mt-1">{errors.parentLastName.message}</p>}
      </div>
    </div>
  </div>
  ...
  <div className="space-y-1">
    ...
    <div className="grid grid-cols-2 gap-4">
      <div>
        ...
        />
        {errors.childFirstName && <p className="text-xs text-red-500 mt-1">{errors.childFirstName.message}</p>}
      </div>
      <div>
        <Input 
          type="text"
        ...
        />
        {errors.childLastName && <p className="text-xs text-red-500 mt-1">{errors.childLastName.message}</p>}
      </div>
    </div>
  </div>
